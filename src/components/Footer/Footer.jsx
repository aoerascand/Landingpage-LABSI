...
</div><div className="flex gap-3"><a href="https://www.instagram.com/labsipadelclub/" aria-label="Instagram" className="grid size-10 place-items-center rounded-full border border-white/10 text-white hover:bg-white/10">
<FaInstagram /></a>
</div><p className="text-xs">© {new Date().getFullYear()} LABSI Padel School. {contactInfo.address}</p></div>
</footer>;
