...
const Hero = () => {
  ...
  <div className="mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-5 pb-16 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:pb-20">
    <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7 }} className="max-w-xl">
      <p className="mb-4 text-xs font-extrabold tracking-[.22em] text-blue-300">{heroContent.eyebrow}</p>
      <div className="mb-5 inline-flex items-center rounded-full border border-labsi-orange/40 bg-labsi-orange/15 px-3.5 py-2 text-sm font-semibold text-orange-200">
      ...
      <div className="mt-9 flex flex-wrap gap-3"><a href="#registration" className="rounded-full bg-labsi-orange px-6 py-3.5 text-sm font-bold shadow-lg shadow-orange-950/30 transition hover:-translate-y-0.5 hover:bg-orange-400">Trial Sekarang</a><a href="#vision" className="rounded-full border border-white/20 px-6 py-3.5 text-sm font-bold transition hover:bg-white/10">Learn More</a></div>
    </motion.div>
